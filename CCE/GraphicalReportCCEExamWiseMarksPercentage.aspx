<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="GraphicalReportCCEExamWiseMarksPercentage.aspx.cs" Inherits="CCE_ReportCCEExamWiseMarksPercentage"
    Title="ExamWise Student Marks Percentage Report" %>
    ...
    <asp:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server">
        ...
        <ContentTemplate>
            <div>
                <table align="center" class="tdcls" width="60%">
                    ...
                    <tr>
                        <td class="heading" colspan="2" style="text-align: center">
                           TABULAR/GRAPHICAL REPORT FOR EXAM WISE STUDENT MARKS PERCENTAGE
                        </td>
                    </tr>
                    <tr>
                        <td>
                ...
                <tr>
                        <td class="heading" colspan="2" style="text-align: center">
                             TABULAR/GRAPHICAL REPORT FOR EXAM WISE STUDENT MARKS PERCENTAGE REPORT FORM
                        </td>
                    </tr>
                    <tr>
                        <td align="center">
