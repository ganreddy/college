<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="DisplayCCEMarks.aspx.cs" Inherits="CCE_DisplayCCEMarks" Title="Display CCE Marks" %>
        ...
        <table align="center" class="tdcls" width="60%">
            ...
            <tr>
                <td align="center" style="height: 15px;" colspan="2">
                    <br />
                    <asp:Button ID="btnAdd" runat="server" Text="Update" Width="50px" OnClick="btnAdd_Click" />
                </td>
            </tr>
            <tr>
