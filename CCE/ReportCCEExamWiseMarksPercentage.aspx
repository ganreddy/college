<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="ReportCCEExamWiseMarksPercentage.aspx.cs" Inherits="CCE_ReportExamWiseMarksPercentage"
                ...
                <table align="center" class="tdcls" width="60%">
                    ...
                    <tr>
                        <td class="heading" colspan="2" style="text-align: center">
                            ExamWise Student Marks Percentage
                        </td>
                    </tr>
                    <tr>
                ...
                <table width="90%" align="center" class="tdcls">
                    <tr>
                        <td colspan="2" class="heading" style="height: 18px">
                            ExamWise Student Marks Percentage Report Form
                        </td>
                    </tr>
                    <tr>
                        <td align="center">
