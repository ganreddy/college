<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="DisplayCoScholasticMarks.aspx.cs" Inherits="CCE_DisplayCoScholasticMarks"
    Title="Display Co-Scholastic Marks" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        ...
        <table align="center" class="tdcls" width="60%">
            ...
            <tr runat="server" visible="false">
                ...
                <td>
                    <asp:DropDownList ID="ddlYear" runat="server" Width="180" OnSelectedIndexChanged="ddlYear_SelectedIndexChanged"
                        AutoPostBack="true">
                    </asp:DropDownList>
                </td>
            </tr>
            ...
            <tr>
                <td class="subhead">
                    ...
                    <td>
                        <asp:DropDownList ID="ddlSkills" runat="server" AutoPostBack="true" Width="180"  TabIndex="2">
            ...
            <tr>
                <td align="center" style="height: 15px;" colspan="2">
                    <br />
                    <asp:Button ID="btnAdd" runat="server" Text="Update" Width="50px"  TabIndex="6" 
                        />
                </td>
            </tr>
            <tr>
