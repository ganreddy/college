<%@ Page Title="Scholastic Wise Students Percentage Count Report" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="ReportScholasticWiseStudentsPercentageCount.aspx.cs" Inherits="CCE_ReportScholasticWiseStudentsPercentageCount" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript" language="javascript">
        function validate() {
            ...
            if (document.getElementById('<%=rbtnGraphical.ClientID%>').checked) {
                if (document.getElementById('<%=ddlChartType.ClientID%>').selectedIndex == 1) {
    ...
    <table align="center" class="tdcls" width="60%">
        ...
        <tr>
            <td class="heading" colspan="2" style="text-align: center">
                Scholastic Wise Students Percentage Count Report
            </td>
        </tr>
        
        <tr>
            <td class="subhead" style="width: 258px">
    ...
    <table width="90%" align="center" class="tdcls">
        <tr>
            <td class="heading" colspan="4" style="text-align: center">
                Scholastic Wise Students Percentage Count Report Form
            </td>
        </tr>
        <tr>
