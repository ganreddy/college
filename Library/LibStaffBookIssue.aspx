<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="LibStaffBookIssue.aspx.cs" Inherits="LibraryModule_LibStaffBookIssue" Title="Library StaffBook Issue" %>
...
<link href="../scripts/StyleSheet.css" rel="stylesheet" type="text/css" />
 ...
 <script type="text/javascript" language="javascript">
    ...
    function RequiredValidate()
    {
        ...
        if (!isEmpty('<%=txtIssueDate.ClientID%>', "Please Enter Issue Date")) return false;
                ...
                <tr>
                    <td colspan="4" align="center">
                        <asp:GridView ID="gdvLibBook" runat="server" AutoGenerateColumns="False" BackColor="#CCCCCC"
                            ...
                            onpageindexchanging="gdvLibBook_PageIndexChanging">
