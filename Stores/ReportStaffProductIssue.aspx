<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="ReportStaffProductIssue.aspx.cs" Inherits="Stores_ReportStaffProductIssue"
    Title="Report StaffProduct Issuee" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div>
        ...
        <table align="center" class="tdcls" width="60%">
            ...
            <tr>
                <td class="subhead" style="width: 93px">
                    Staff
                </td>
                <td>
                    <asp:DropDownList ID="ddlStaff" runat="server" Height="18px" Width="154px">
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
        ...
        <tr>
                <td colspan="2" class="heading" style="height: 18px">
                    STAFF PRODUCT ISSUE REPORT FORM
                </td>
            </tr>
            <tr>
                <td>
