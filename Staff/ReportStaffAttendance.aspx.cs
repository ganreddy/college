...
public partial class Staff_ReportStaffAttendance : System.Web.UI.Page
{
    ...
    protected void btnReport_Click(object sender, EventArgs e)
    {
        ...
        MyReportViewer.ServerReport.ReportPath = ConfigurationManager.AppSettings["ReportsFolder"].ToString() + "MonthlyStaffAttendance"; // Report Name
