<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="ReportStaffPreviousPostings.aspx.cs" Inherits="Staff_ReportStaffPreviousPostings"
    Title="Staff Previous Postings Report" %>
            ...
            <table align="center" class="tdcls" width="60%">
                <tr>
                    <td colspan="2" class="heading">
                        STAFF PREVIOUS POSTINGS REPORT
                    </td>
                </tr>
                <tr>
                ...
                <table align="center" class="tdcls" width="90%">
                    <tr>
                        <td colspan="2" class="heading" style="height: 18px">
                            STAFF PREVIOUS POSTINGS REPORT FORM
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <rsweb:ReportViewer ID="StaffPrevPostingsReportViewer" runat="server" 
                                Width="100%">
                            </rsweb:ReportViewer>
                        </td>
                    </tr>
