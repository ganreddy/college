...
function CheckDecimal(inputtxt,HelperMsg)
{
var numbers =/^[0-9]+(\.[0-9]+)+$/;
if(document.getElementById(inputtxt).value.match(numbers)) 
{
return true;
}
else
...
function DateFormat12(PreDate,currentDate,strErrMsg)
 {
...
function DateFormat123(Date1,Date2,strErrMsg)
 {
