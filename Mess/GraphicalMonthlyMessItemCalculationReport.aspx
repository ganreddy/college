<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="GraphicalMonthlyMessItemCalculationReport.aspx.cs" Inherits="Mess_YearlyMessItemCalculationReport"
    Title="Monthly/Yearly Mess Item Calculation Report" %>
    ...
    <table align="center" class="tdcls" width="60%">
        <tr>
            <td colspan="2" class="heading">
                TABULAR/GRAPHICAL MONTHLY DISH CALCULATION REPORT
            </td>
        </tr>
        <tr>
            <td class="subhead">
    ...
    <table align="center" class="tdcls" width="90%">
        <tr>
            <td colspan="2" class="heading" style="height: 18px">
               TABULAR/GRAPHICAL MONTHLY DISH CALCULATION REPORT FORM 
            </td>
        </tr>
        <tr>
            <td>
