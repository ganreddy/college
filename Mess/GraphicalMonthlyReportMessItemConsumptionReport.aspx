<%@ Page Title="Monthly Item Consumption Report" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="GraphicalMonthlyReportMessItemConsumptionReport.aspx.cs" Inherits="Mess_ReportMessItemConsumptionReport" %>
    ...
    <table align="center" class="tdcls" width="60%">
        <tr>
            <td colspan="2" class="heading">
                TABULAR/GRAPHICAL MONTHLY ITEM CONSUMPTION REPORT
            </td>
        </tr>
        <tr>
    ...
    <table align="center" class="tdcls" width="90%">
        <tr>
            <td colspan="2" class="heading" style="height: 18px">
                TABULAR/GRAPHICAL MONTHLY ITEM CONSUMPTION REPORT FORM 
            </td>
        </tr>
        <tr>
            <td>
