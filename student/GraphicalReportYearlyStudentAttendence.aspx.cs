...
public partial class student_GraphicalReportYearlyStudentAttendence : System.Web.UI.Page
{
    ...
    protected void btnReport_Click(object sender, EventArgs e)
    {
        ...
        if (rbtnGraphical.Checked)
        {
            if (ddlChartType.SelectedIndex == 1)
            {
                ...
                ReportStuYearlyAttendence.ServerReport.ReportPath = ConfigurationManager.AppSettings["ReportsFolder"].ToString() + "BarChartYearlyStudentAttendanceReport"; // Report Name
            ...
            if (ddlChartType.SelectedIndex == 2)
            {
                ReportStuYearlyAttendence.ProcessingMode = Microsoft.Reporting.WebForms.ProcessingMode.Remote;
                ReportStuYearlyAttendence.ServerReport.ReportServerUrl = new Uri(ConfigurationManager.AppSettings["ReportsURI"].ToString()); // Report Server URL
                ReportStuYearlyAttendence.ServerReport.ReportPath = ConfigurationManager.AppSettings["ReportsFolder"].ToString() + "LineChartYearlyStudentAttendanceReport"; // Report Name
                ReportStuYearlyAttendence.ShowParameterPrompts = false;
                ReportStuYearlyAttendence.ShowPrintButton = true;
                ReportStuYearlyAttendence.ShowToolBar = true;
                ReportStuYearlyAttendence.SizeToReportContent = true;
        ...
        if (rbtnTabularReport.Checked)
        {
            ReportStuYearlyAttendence.ProcessingMode = Microsoft.Reporting.WebForms.ProcessingMode.Remote;
            ReportStuYearlyAttendence.ServerReport.ReportServerUrl = new Uri(ConfigurationManager.AppSettings["ReportsURI"].ToString()); // Report Server URL
            ReportStuYearlyAttendence.ServerReport.ReportPath = ConfigurationManager.AppSettings["ReportsFolder"].ToString() + "YearlyStudentAttendance"; // Report Name
            ReportStuYearlyAttendence.ShowParameterPrompts = false;
            ReportStuYearlyAttendence.ShowPrintButton = true;
            ReportStuYearlyAttendence.ShowToolBar = true;
            ReportStuYearlyAttendence.SizeToReportContent = true;
