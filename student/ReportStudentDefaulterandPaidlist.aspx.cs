...
public partial class student_ReportStudentDefaulterandPaidlist : System.Web.UI.Page
{
    ...
    {
        string Batch = string.Empty, Class = string.Empty, Section = string.Empty, Student = string.Empty, List = string.Empty, Year = string.Empty;
        ...
        MyReportViewer.ServerReport.ReportPath = ConfigurationManager.AppSettings["ReportsFolder"].ToString() + "ReportDefaulterspaidstudentlist"; // Report Name
        ...
        reportParameterCollection[4] = new Microsoft.Reporting.WebForms.ReportParameter("List", List);
