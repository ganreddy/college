...
public partial class student_ReportStudentLeaves : System.Web.UI.Page
{
    ...
    protected void btnReport_Click(object sender, EventArgs e)
    {
        ...
        MyReportViewer.ServerReport.ReportPath = ConfigurationManager.AppSettings["ReportsFolder"].ToString() + "StudentLeaves"; // Report Name
