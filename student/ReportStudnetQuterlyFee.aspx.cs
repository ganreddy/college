...
public partial class student_ReportStudnetQuterlyFee : System.Web.UI.Page
{
    ...
    {
        string Batch = string.Empty, Class = string.Empty, Section = string.Empty, Student = string.Empty, Month = string.Empty, Year = string.Empty,List=string.Empty;
        ...
        List = ddlQuterList.SelectedValue;  
        ...
        MyReportViewer.ServerReport.ReportPath = ConfigurationManager.AppSettings["ReportsFolder"].ToString() + "ReportQuarterlyStudentFee"; // Report Name
        ...
        reportParameterCollection[4] = new Microsoft.Reporting.WebForms.ReportParameter("Quterly", List);
