<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StudentAttendance.aspx.cs"
    Inherits="StudentAttendance" MasterPageFile="~/MasterPage.master" Title="Student Attendance" %>
        ...
        <ContentTemplate>
            <div>
                <table align="center" class="tdcls" width="50%">
                    ...
                    <tr>
                        <td class="subhead">
                            Branch <span style="font-size: 17px; color: Red">*</span>
                        </td>
                        <td width="30">
                    ...
                    <tr>
                        ...
                        <td width="30">
                            <asp:DropDownList ID="ddlSections" runat="server" Width="154px" OnSelectedIndexChanged="ddlSections_SelectedIndexChanged"
                                AutoPostBack="true">
                                <asp:ListItem>Select</asp:ListItem>
                                <asp:ListItem>Selefdct</asp:ListItem>
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddlMonth" runat="server" Height="16px" Width="76px">
                            ...
                            <asp:DropDownList ID="ddlYear" runat="server" Height="16px" Width="75px">
                    ...
                    oncheckedchanged="chkFullance_CheckedChanged"  />--%>
                            <asp:Button ID="btnAttendance" runat="server" Text="Mark Attendance" OnClick="btnAttendance_Click" />
                        </td>
                    </tr>
                    <tr>
                            ...
                            <asp:GridView ID="gdvStuAttenance" runat="server" AutoGenerateColumns="False" BackColor="#CCCCCC"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="No OF Days Present">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtNoOfDaysPresents" runat="server" onkeypress="return Numeric(event)"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                            </asp:GridView>
